...
<body class="fix-header">
    ...
    <div id="main-wrapper">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">hardware</span></a>
                            <ul aria-expanded="false" class="collapse">
        ...
        <div class="page-wrapper" style="height:1200px;">
            ...
            <!-- End Container fluid  -->
            <!-- footer -->
            <footer class="footer"> © 2024 All rights reserved. HANA CHICKEN</a></b> Team. </footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>

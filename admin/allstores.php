                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                               	...
                                               	<?php
												$sql="SELECT * FROM hardware order by st_id desc";
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																				...
																				$mql="SELECT * FROM store_category where c_id='".$rows['c_id']."'";
																					...
																					echo ' <tr><td>'.$row['c_name'].'</td>
																								...
																								<td>'.$rows['date'].'</td>
																									 ...
																									 <a href="update_store.php?res_upd='.$rows['st_id'].'" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="ti-settings"></i></a>
																									</td></tr>';

...
if(isset($_POST['submit']))           //if upload btn is pressed
{
		...
		if(empty($_POST['d_name'])||empty($_POST['about'])||$_POST['price']==''||$_POST['store_name']=='')
		{	
	...
	else
		{
				...
				$fname = $_FILES['file']['name'];
								...
								$store = "Res_img/hardwares/".basename($fnew);                      // the path to store the upload image
					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "update hardwares set st_id='$_POST[store_name]',title='$_POST[d_name]',slogan='$_POST[about]',price='$_POST[price]',img='$fnew' where d_id='$_GET[menu_upd]'";  // update the submited data ino the database :images
												mysqli_query($db, $sql); 
...
<body class="fix-header">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper" style="height:1200px;">
                        ...
                        <div class="card card-outline-primary">
                            ...
                            <div class="card-body">
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                        <?php $qml ="select * from hardwares where d_id='$_GET[menu_upd]'";
                                        ...
                                        <div class="row">
											 ...
											 <div class="col-md-12">
                                                <div class="form-group">
													...
													<select name="store_name" class="form-control custom-select" data-placeholder="Choose a Category" tabindex="1">
                                                        <option>--Select any Shop--</option>
                                                 <?php $ssql ="select * from hardware";
													$res=mysqli_query($db, $ssql); 
													while($row=mysqli_fetch_array($res))  
													{
                                                       echo' <option value="'.$row['st_id'].'">'.$row['title'].'</option>';;
													}  
            ...
            <!-- End Container fluid  -->
            <!-- footer -->
			<footer class="footer"> © 2024 All rights reserved. HARDWARE</a></b> Team. </footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>

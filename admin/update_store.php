...
if(isset($_POST['submit']))           //if upload btn is pressed
{
		...
		if(empty($_POST['c_name'])||empty($_POST['store_name'])||$_POST['email']==''||$_POST['phone']==''||$_POST['url']==''||$_POST['o_hr']==''||$_POST['c_hr']==''||$_POST['o_days']==''||$_POST['address']=='')
		{	
					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "update hardware set c_id='$_POST[c_name]', title='$store_name',email='$_POST[email]',phone='$_POST[phone]',url='$_POST[url]',o_hr='$_POST[o_hr]',c_hr='$_POST[c_hr]',o_days='$_POST[o_days]',address='$_POST[address]',image='$fnew' where st_id='$_GET[res_upd]' ";  // store the submited data ino the database :images												mysqli_query($db, $sql); 
													mysqli_query($db, $sql); 
...
<body class="fix-header">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper" style="height:1200px;">
                        ...
                        <div class="card card-outline-primary">
                            ...
                            <div class="card-body">
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                       <?php $ssql ="select * from hardware where st_id='$_GET[res_upd]'";
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="store_name" value="<?php echo $row['title'];  ?>" class="form-control" placeholder="John doe">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                            ...
                                            <!--/span-->
											 ...
											 <div class="col-md-12">
                                                <div class="form-group">
                                                 ...
                                                 <?php $ssql ="select * from store_category";
													$res=mysqli_query($db, $ssql); 
            ...
            <!-- End Container fluid  -->
            <!-- footer -->
			<footer class="footer"> © 2024 All rights reserved. Made  by <b> HARDWARE</a></b> Team. </footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>

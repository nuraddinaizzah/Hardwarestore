...
if(isset($_POST['submit'] ))
{
	...
	$check_cat= mysqli_query($db, "SELECT c_name FROM store_category where c_name = '".$_POST['c_name']."' ");
	...
	$mql = "INSERT INTO store_category(c_name) VALUES('".$_POST['c_name']."')";
	mysqli_query($db, $mql);
...
<head>
    ...
    <title>EasyHardware - Admin Dashboard</title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper" style="height:1200px;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary"></h3>All hardware Categories</div>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped" >
                                        ...
                                        <tbody style="text-align: center">
											...
											<?php
												$sql="SELECT * FROM store_category order by c_id desc";
